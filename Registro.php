                                ...
                                <div class="card-header pb-0 text-start colorFondo">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <h2 class="font-weight-bolder" style="margin-top:25px;">SISTEMA DE
                                                    SOPORTE</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <br> <br>
                                    <h3 id="lbltitulo" style="text-align:center; color: #ced6db;">Registro de usuario
                                    </h3> <br>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form role="form" id="frmRegistro" method="post">
                                        ...
                                        <div class="txt_field">
                                            <input type="text" id="numEmpleadoNewUser" name="numEmpleadoNewUser"
                                                required>
                                            <span></span>
                                            <label>Número de empleado</label>
                                        </div>
                                        <div>
                                            <label style=" color: #adadad; font-size: 16px;">Seleccione el departamento
                                                al que pertenece</label> <br>
                                            <select name="departamentoT" id="departamentoT"
                                        ...
                                        <div class="text-center">
                                            <button type="button" name="btnReg" id="btnReg" class="btn inicioSs"
                                                onclick="registrarUsuario()">Registrarse</button>
                                        </div>
