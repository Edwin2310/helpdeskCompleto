<?php if (!$_SESSION['nombre'] == "" && !$_SESSION['tipo'] == "") {
  ...
  if (isset($_POST['old_pass_update']) && isset($_POST['new_pass_update'])) {
    ...
    $sqlPass = "SELECT clave FROM tbl_usuarios WHERE email_usuario= '$email_update'";
    ...
    if ($passConsulta == $old_pass_update) {
      ...
      if (MysqlQuery::Actualizar("tbl_usuarios", " clave='$new_pass_update'", "email_usuario= '$email_update'")) {
        ...
        echo '
                <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                      ¡Tus contraseña ha sido actualizado correctamente!
                    </p>
                </div>
              ';
      } else {
  ...
  <div class="container">
    <div class="row well">
      ...
      <div class="col-sm-9 lead">
        <h2 class="text-info">
          <center>Cambio de contraseña
        </h2>
        <h2 class="text-info">
          <center>Soporte Técnico 9-1-1
        </h2>
        <br></br>
    ...
    $nameU = "SELECT * FROM tbl_usuarios WHERE email_usuario = '$aa'";
