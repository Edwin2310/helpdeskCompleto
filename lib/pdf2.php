...
$pdf->Cell (36,10,'Regional',1,0,'C',true);
$pdf->Cell (0,10,utf8_decode($reg['regional']),1,1,'L');
$pdf->Cell (36,10,'Asunto',1,0,'C',true);
$pdf->Cell (0,10,utf8_decode($reg['sistema']),1,1,'L');
$pdf->Cell (36,15,utf8_decode('Problema'),1,0,'C',true);
$pdf->Cell (0,15,utf8_decode($reg['reporte']),1,1,'L');
