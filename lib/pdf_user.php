...
$pdf->Cell (36,10,'Problema',1,0,'C',true);
$pdf->Cell (0,10,utf8_decode($reg['asunto']),1,1,'L');
$pdf->Cell (36,15,utf8_decode('Descripción'),1,0,'C',true);
$pdf->Cell (0,15,utf8_decode($reg['mensaje']),1,1,'L');
$pdf->Cell (36,15,utf8_decode('Solución'),1,0,'C',true);
$pdf->Cell (0,15,utf8_decode($reg['solucion']),1,1,'L');
$pdf->Cell (36,15,'Atendido Por:',1,0,'C',true);
$pdf->Cell (0,15,utf8_decode($reg['atendidopor']),1,1,'L');
