...
<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="1"){ ?>    
    ...
    <li><a href="./admin.php?view=bienes" style="color:#c1d12d;"><i class="fa fa-address-card-o" style="color:#c1d12d;"></i>&nbsp;&nbsp;Bienes&nbsp;&nbsp;<span class="badge"><?php echo $num_total_bienes; ?></span></a></li>
    ...
    <li><a href="./admin.php?view=deshabilitados"><i class="fa fa-user-times"></i>&nbsp;&nbsp;Deshabilitados&nbsp;&nbsp;<span class="badge"><?php echo $num_total_desac; ?></span></a></li>
    ...
    $selusers=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM tbl_admin WHERE id_rol='5' AND  estado='1' ");
    ...
    if(mysqli_num_rows($selusers)>0):
        ...
        while ($row=mysqli_fetch_array($selusers, MYSQLI_ASSOC)): 
            ...
            <td class="text-center"><?php if($row['id_rol']==5){
