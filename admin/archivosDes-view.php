...
$sel = $con->query("SELECT * FROM tbl_archivosdes ORDER BY fecha DESC");
    ...
    <body>
        ...
        <div class="row well">
            ...
            <a href="./index.php" style="margin: 5px" class="btn btn-success pull-right"><i class="fa fa-reply"></i>&nbsp;&nbsp;Regresar a Inicio</a>
                 <h2 align="center" class="text-info ">Reportes Desarrolladores</h2>
            <h4 class="text-primary"> En esta seccion se subiran los reportes una vez terminada su asignacion.</h4> 
            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <?php
                                $dept=Mysql::consulta("SELECT id_usuario, nombre_completo FROM tbl_usuarios WHERE id_rol='Desarrollador'");
