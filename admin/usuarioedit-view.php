...
/*Llamado de los campos de la base de datos*/
    ...
    $correo= utf8_encode( MysqlQuery::RequestPost('correo'));
		...
		if(MysqlQuery::Actualizar("tbl_usuarios",  "nombre_completo='$nombre', nombre_usuario='$usuario', telefono='$telefono', email_usuario='$correo'", "id_usuario=$id_edit")){

			echo '
                <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                    <h4 class="text-center">USUARIO MODIFICADO</h4>
                    <p class="text-center">
