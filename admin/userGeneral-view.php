...
<?php if ($_SESSION['nombre'] != "" && $_SESSION['tipo'] == "1") { ?>
    ...
    if (isset($_POST['id_del'])) {
        ...
        if (MysqlQuery::Eliminar("tbl_usuarios", "id_usuario='$id_user'")) {
            ...
            //CONSULTA PARA DESACTVAR ENUSO
            $sql1 = "UPDATE tbl_numeroempleado SET EnUso = '0' WHERE Codigo = '$numEE'";
    ...
    if (isset($_POST['id_estado'])) {
        ...
        if (MysqlQuery::Actualizar("tbl_usuarios", "estado='0'", "id_usuario='$id_user'")) {
            ...
            <h4 class="text-center">OCURRIÓ UN ERROR</h4>
            <p class="text-center">
            No hemos podido desactivado el usuario
            </p>
            </div>
            ';
        }
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <ul class="nav nav-pills nav-justified">
                    ...
                    <li><a href="./admin.php?view=userGeneral" style="color:#c1d12d;"><i class="fa fa-user" style="color:#c1d12d;"></i>&nbsp;&nbsp;Usuarios&nbsp;&nbsp;<span class="badge">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    $selusers_admin = mysqli_query($mysqli, "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_usuarios WHERE id_rol='4' AND  estado='1'");
                                ...
                                ?>
                                        ...
                                        <td class="text-center">
                                            ...
                                            ?>
                                                <form action="" method="POST" style="display: inline-block;">
                                                    ...
                                                    <input type="hidden" name="numeroEmpleado" value="<?php echo $row['numeroEmpleado']; ?>">
                                    ...
                                    --> </button>
                                                    ...
                                                    <form action="" method="POST" style="display: inline-block;">
                                                        ...
                                                        <input type="hidden" name="numeroEmpleado" value="<?php echo $row['numeroEmpleado']; ?>">
                                                        <!----SE LE AGREGAR ESTO PARA QUE PUEDA BORRAR Y DEJARLO EN 0 EL ENUSO ---->
