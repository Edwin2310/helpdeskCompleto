...
<html>
    ...
    <body>
        ...
        <div class="row well">
            ...
            <h4 class="text-primary"> En esta seccion, se subiran los reportes una vez terminada su asignacion. De igual manera debera entregarlo de forma fisica </h4> 
            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <?php
                                $dept=Mysql::consulta("SELECT id_usuario, nombre_completo FROM tbl_usuarios WHERE id_rol='tecnico'");
