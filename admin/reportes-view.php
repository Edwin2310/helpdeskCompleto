...
if (isset($_POST['id_del'])) {
    ...
    if (MysqlQuery::Eliminar("tbl_reportes", "id='$id'")) {
        echo '
...
// $sel = $con->query("SELECT * FROM tbl_reportes ORDER BY fecha DESC");
$consu = "SELECT * FROM tbl_reportes ORDER BY fecha DESC";
...
<body>
    <div class="container">
        <div class="row well">
            ...
            <div class="col-sm-9 lead">
                ...
                <h2 align="center" class="text-info ">Reportes</h2>
                                        ...
                                        <div class="row justify-content-md-center" style="margin: 5px">
                                            <div class="col-12">
                                                <?php if ($_SESSION['nombre'] != "" && $_SESSION['tipo'] == "1") { ?>
                                                    <button style="margin: 5px" type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#exampleModal">
                                                        Subir Archivo
                                                    </button>
                                                <?php } ?>
                                                        ...
                                                        <?php foreach ($res as $val) { ?>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <center><a class="btn btn-primary" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/helpdeskCompleto/' . $val['url']; ?>">Ver Archivo</a></center>
    ...
    <script type="text/javascript">
        function onSubmitForm() {
            ...
            xhttp.open("POST", "./uploaddes.php", true);
            xhttp.send(data);
            $('#form1').trigger('reset');
