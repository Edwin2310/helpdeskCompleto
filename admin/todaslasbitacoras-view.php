...
<?php if ($_SESSION['nombre'] != "" || $_SESSION['tipo'] == "1" || $_SESSION['tipo'] == 2) { ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-17" aria-label="Basic example">
                <a href="./admin.php?view=bitacora" style="margin: 5px" class="btn btn-success pull-right"><i
                        class="fa fa-reply"></i>&nbsp;&nbsp;Regresar a Bitacoras</a>
            </div>
            ...
            <br>
            <br>
            <h2 class="text-info"> &nbsp;Bienvenido aquí se muestran todas las Bitacoras ingresadas al Sistema.</h2>
        </div>
    </div>
    <br>
    ...
    if (isset($_POST['id_bitacora'])) {
        $id = MysqlQuery::RequestPost('id_bitacora');
        if (MysqlQuery::Eliminar("tbl_bitacoras", "id_bitacora='$id'")) {
            echo '
    ...
    $num_ticket_all = Mysql::consulta("SELECT * FROM tbl_bitacoras");
            ...
            <div class="col-md-20">
                <div class="table-responsive">
                    ...
                    if (isset($_GET['ticket'])) {
                        if ($_GET['ticket'] == "all") {
                            $consulta = "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_bitacoras ORDER BY fecha DESC  ";
                        } elseif ($_GET['ticket'] == "pending") {
                            $consulta = "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_bitacoras WHERE estado_bitacora='Pendiente' ";
                        } elseif ($_GET['ticket'] == "process") {
                            $consulta = "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_bitacoras WHERE estado_bitacora='En Proceso' ";
                        } elseif ($_GET['ticket'] == "resolved") {
                            $consulta = "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_bitacoras WHERE estado_bitacora='Resuelto' ";
                        } elseif ($_GET['ticket'] == "rejected") {
                            $consulta = "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_bitacoras WHERE estado_bitacora='Rechazado'";
                        } else {
                            $consulta = "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_bitacoras ORDER BY fecha DESC ";
                        }
                    } else {
                            ...
                            <table id="example" class="table table-hover table-striped table-bordered  table-sm align-bottom">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Tecnicos</th>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($selticket, MYSQLI_ASSOC)):
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php echo $row['departamento_ticket']; ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $row['regional_ticket']; ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $row['tecnicos_ticket']; ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $row['descripcion_equipos']; ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $row['problema_presentado']; ?>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="./lib/pdf_bitacora.php?id_bitacora=<?php echo $row['id_bitacora']; ?>"
                                                ...
                                                <?php if ($_SESSION['nombre'] != "" && $_SESSION['tipo'] == "1") { ?>
                                                    ...
                                                    <form action="" method="POST" style="display: inline-block;">
                                                        <input type="hidden" name="id_bitacora"
                                                            value="<?php echo $row['id_bitacora']; ?>">
...
?>
    ...
    <script type="text/javascript">
        function excel() {
            window.open("process/excelBitacora.php?Tipoticket=0");
            // console.log("funciona");
        }

        function pdfReport() {
            window.open("lib/reportesBitacoras.php?Tipoticket=0");
            // console.log("funciona");
        }
    </script>