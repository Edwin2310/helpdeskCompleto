...
<?php if ($_SESSION['nombre'] != "" && $_SESSION['clave'] != "") { ?>
    <div class="container">
        <div class="row">
            ...
            <br>
            <!-- Mensaje -->
            <h2 class="text-info"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Bienvenido aquí se muestran todos los Tickets en
                Proceso.</h2>
            <!-- Fin mensaje -->
        </div>
    </div>
    ...
    /*Suma de los  en proceso*/
    /* Tickets en proceso*/
    $num_ticket_proceso = Mysql::consulta("SELECT * FROM tbl_ticket WHERE estado_ticket='En Proceso'");
    $num_total_proceso = mysqli_num_rows($num_ticket_proceso);


    ?>
    <!-- Contenedor que muestra los tickets en proceso -->
    <div class="container">
        <div class="row">
            <div class="col-md-25">
