...
<?php if ($_SESSION['nombre'] != "" && $_SESSION['tipo'] == "1") { ?>
    ...
    if (isset($_POST['id_estado'])) {
        ...
        if (MysqlQuery::Actualizar("tbl_admin", "estado='0'", "id_usuario='$id_user'")) {
    ...
    if (isset($_POST['id_del'])) {
        ...
        if (MysqlQuery::Eliminar("tbl_admin", "id_usuario='$id_admin'")) {
            echo '
            <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
    ...
    $num_usuer_desac = Mysql::consulta("SELECT * FROM tbl_usuarios WHERE id_rol ='4' AND estado = '0'");
    ...
    <br><br>
    <!-- Container Usuarios registrados -->
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <ul class="nav nav-pills nav-justified">
                    <li><a href="./admin.php?view=users"><i class="fa fa-users"></i>&nbsp;&nbsp;Técnicos&nbsp;&nbsp;<span class="badge">
                                <?php echo $num_total_usuario; ?>
                            </span></a></li>
                    <li><a href="./admin.php?view=admin" style="color:#c1d12d;"><i class="fa fa-male" style="color:#c1d12d;"></i>&nbsp;&nbsp; Administradores &nbsp;&nbsp;<span class="badge">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    $seladmin = mysqli_query($mysqli, "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_admin WHERE id_rol='1' AND  estado='1' LIMIT $inicio, $regpagina");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            if ($row['estado'] == 1) {
                                            ?>
                                                <form action="" method="POST" style="display: inline-block;" onsubmit="return validateForm();">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7 animated flip">
                <h1 class="text-danger">Lo sentimos esta página es solamente para administradores de Soporte Técnico 9-1-1
                </h1>
...
<script type="text/javascript">
    function validateForm() {
        var x = document.getElementById("id_del").value;
        if (x.trim() == "") {
