...
<html>
    ...
    <body>
        ...
        <div class="row well">
            ...
            <h4 class="text-primary"> En esta secci&oacuten se subiran los informes t&eacutecnicos </h4> 
            </div>
                    ...
                    <div class="col-sm-12">
                      <div class="panel panel-info">
                        <div class="panel-heading">
                          <h3 class="panel-title text-center"><strong><i class="fa fa-ticket"></i>&nbsp;&nbsp;&nbsp;Archivos Disponibles</strong></h3>
                        </div>
                        ...
                        <div class="col-8">
                            ...
                            <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#exampleModal">Subir Dictamen</button>
                            <?php }?>
                            ...
                            <table id="example" class="table mt-2 table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;" scope="col">Ticket</th>
                            ...
                            <div class="modal-body">
                                <form enctype="multipart/form-data" id="form1">
                                    ...
                                    <div class="form-group">
                                        <label for="title">Id Ticket</label>
                                        <select class="form-control" id="title" type="title" name="title" >
                              <option value=""> --- Seleccionar Ticket ---</option>
                              <?php

                                $dept=Mysql::consulta("SELECT id, serie FROM ticket ORDER BY fecha DESC");

                                while($usuario = mysqli_fetch_array($dept)){
                                ?>
                                  <option required="" value="<?php echo $usuario["serie"]?>"> <?php echo $usuario["serie"]?> </option>
                                <?php }  ?>
                            </select>
                                    </div>
