...
<?php if ($_SESSION['nombre'] != "" && $_SESSION['tipo'] == "1") { ?>
    ...
    if (isset($_POST['id_del'])) {
        ...
        if (MysqlQuery::Eliminar("tbl_admin", "id_usuario='$id_user'")) {
            ...
            <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="text-center">DESARROLADOR ELIMINADO</h4>
            <p class="text-center">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <ul class="nav nav-pills nav-justified">
                    ...
                    <li><a href="./admin.php?view=desarrolladores" style="color:#c1d12d;"><i class="fa fa-desktop"
                                style="color:#c1d12d;"></i>&nbsp;&nbsp;Desarrolladores&nbsp;&nbsp;<span class="badge">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    $selusers = mysqli_query($mysqli, "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_admin WHERE id_rol='3' AND  estado='1'  ");
