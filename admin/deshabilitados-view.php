...
<?php if ($_SESSION['nombre'] != "" && $_SESSION['tipo'] == "1") { ?>
    ...
    if (isset($_POST['id_del'])) {
        ...
        if (MysqlQuery::Eliminar("tbl_admin", "id_usuario='$id_user'")) {
            echo '
    ...
    if (isset($_POST['id_estado'])) {
        ...
        if (MysqlQuery::Actualizar("tbl_usuarios", "estado='1'", "id_usuario='$id_user'")) {

            //CONSULTA PARA ACTIVAR ESTADO EN TABLA USUARIOS
            $sql2 = "UPDATE tbl_admin SET estado = '1'  WHERE id_usuario = '$id_user' ";
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <ul class="nav nav-pills nav-justified">
                    ...
                    <li><a href="./admin.php?view=deshabilitados" style="color:#c1d12d;"><i class="fa fa-user-plus" style="color:#c1d12d;"></i>&nbsp;&nbsp;Habilitar Otros &nbsp;&nbsp;<span class="badge">
                                <?php echo $num_total_desac; ?>
                            </span></a></li>
                    <li><a href="./admin.php?view=desactivar"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;Habilitar
                            Usuarios&nbsp;&nbsp;<span class="badge">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    $selusers_admin = mysqli_query($mysqli, "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_admin WHERE id_rol >='1' AND  estado='0' ");
